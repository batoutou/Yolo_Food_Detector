...
def parse_args():
    ...
    parser.add_argument('-t', '--train', dest='train', type=str, nargs=1,
                        help='Training option : GPU or Google Colab \nEnter gpu or colab')
    ...
    if args.path[0] != 'gpu' or 'colab':
        print('\nWrong argument given ==> gpu / colab\n')
        exit()
